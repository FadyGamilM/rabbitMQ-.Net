...
channel.QueueBind(
   ...
   exchange: "routingExchange",
   // the routing key 
   routingKey: "ProductsWhareHouse" // any thing related to Egypt branch 
);
...
consumer.Received += (model, encodedMsg) => {
   ...
   System.Console.WriteLine($"[RECIEVED MESSAGE By Inventory Microservice] => {message}");
};
...
System.Console.WriteLine("Inventory microservice starts consuming");
